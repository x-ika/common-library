...
public final class GeometryUtils {
    ...
    public static double[] updateBoundingBox(int n, double[] x, double[] y, double[] box) {
        return updateBoundingBox(n, ArraySort.ORDER, x, y, box);
    }
    ...
    {
        return ifrotate(ox, oy, a, n, ArraySort.ORDER, x, y, sin, cos, box);
    }
    ...
    {
        rotate(ox, oy, a, n, ArraySort.ORDER, x, y, sin, cos);
    }
    ...
    public static void move(double dx, double dy, int n, double[] x, double[] y) {
        move(dx, dy, n, ArraySort.ORDER, x, y);
    }
    ...
    public static int getConvexHull(int n, double[] x, double[] y) {
        ...
        ArraySort.restore(0, n, x, y);
        ArraySort.transformBy(0, sz, ArraySort.P, h);
        return sz;
    ...
    public static double getVolume(Polyhedron tank, double x, double y, double z, double ax, double ay) {

        Plane fuelSurface = new Plane(x, y, z, ax, ay);
        Point3D underground = new Point3D(0, 0, -1e9);
