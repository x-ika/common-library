...
import com.simplejcode.commons.misc.structures.d3.*;
...
public class TestRunner {
    ...
    private static void test6() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            long startTime = System.nanoTime();
            System.out.println("LD: " + StringUtils.getLevenshteinDistancce(p, q));
            System.out.println("Time: " + (System.nanoTime() - startTime) / 1e9);
            startTime = System.nanoTime();
            StringUtils.prepare(p);
            System.out.println("LD: " + StringUtils.distanceTo(q));
            System.out.println("Time: " + (System.nanoTime() - startTime) / 1e9);
            System.out.println("");
        }
    ...
    private static void test8() {
        ...
        TankVolumeCalculator calculator = new TankVolumeCalculator(getCube());

        System.out.println(calculator.getVolume(0, 0, 0.5, Math.atan(0.5), 0));
