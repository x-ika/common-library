...
public final class ProgramRunner {
    ...
    public static int runProgram(File exec, int waitTime, String... params) throws Exception {
    ...
    public static int runProgram(String command, int waitTime) throws Exception {
