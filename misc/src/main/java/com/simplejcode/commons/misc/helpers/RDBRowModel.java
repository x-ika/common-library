...
public class RDBRowModel implements Serializable {
    ...
    public RDBRowModel getRecord(String key) {
        return (RDBRowModel) get(key);
    }
    ...
    public RDBRowModel getRecord(String... keys) {
        return (RDBRowModel) get(keys);
    }
